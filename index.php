...
<body class="bg-light d-flex flex-column min-vh-100">
    <nav class="navbar login-navbar py-3 shadow-sm">
        <div class="container d-flex align-items-center gap-3">
            <a href="index.php" class="login-back-link d-inline-flex align-items-center justify-content-center rounded-circle" data-role="back-link" aria-label="Go back" title="Go back">
                <i class="bi bi-chevron-left"></i>
            </a>
            <div class="d-flex align-items-center gap-2">
                <span class="login-app-icon d-inline-flex align-items-center justify-content-center">
                    <i class="bi bi-trophy-fill"></i>
                </span>
                <span class="login-brand-text">Sports MIS</span>
            </div>
        </div>
    </nav>
